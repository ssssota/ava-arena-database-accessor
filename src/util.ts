...
export function getClassName(url: string): string {
  return classUrlMap.get(url.replace(/(?<!:)\/\//,'/')) || '訓練兵';
}

// 画像とRPランクを関連付ける
const arenaRankUrlMap = new Map([
  ['https://file.gameon.jp/ava/images/member/arena/rank_mark/bronze1.png', 'ブロンズ1'],
  ['https://file.gameon.jp/ava/images/member/arena/rank_mark/bronze2.png', 'ブロンズ2'],
  ['https://file.gameon.jp/ava/images/member/arena/rank_mark/bronze3.png', 'ブロンズ3'],
  ['https://file.gameon.jp/ava/images/member/arena/rank_mark/bronze4.png', 'ブロンズ4'],
  ['https://file.gameon.jp/ava/images/member/arena/rank_mark/bronze5.png', 'ブロンズ5'],
  ['https://file.gameon.jp/ava/images/member/arena/rank_mark/silver1.png', 'シルバー1'],
  ['https://file.gameon.jp/ava/images/member/arena/rank_mark/silver2.png', 'シルバー2'],
  ['https://file.gameon.jp/ava/images/member/arena/rank_mark/silver3.png', 'シルバー3'],
  ['https://file.gameon.jp/ava/images/member/arena/rank_mark/silver4.png', 'シルバー4'],
  ['https://file.gameon.jp/ava/images/member/arena/rank_mark/silver5.png', 'シルバー5'],
  ['https://file.gameon.jp/ava/images/member/arena/rank_mark/gold1.png', 'ゴールド1'],
  ['https://file.gameon.jp/ava/images/member/arena/rank_mark/gold2.png', 'ゴールド2'],
  ['https://file.gameon.jp/ava/images/member/arena/rank_mark/gold3.png', 'ゴールド3'],
  ['https://file.gameon.jp/ava/images/member/arena/rank_mark/gold4.png', 'ゴールド4'],
  ['https://file.gameon.jp/ava/images/member/arena/rank_mark/gold5.png', 'ゴールド5'],
  ['https://file.gameon.jp/ava/images/member/arena/rank_mark/platinum1.png', 'プラチナ1'],
  ['https://file.gameon.jp/ava/images/member/arena/rank_mark/platinum2.png', 'プラチナ2'],
  ['https://file.gameon.jp/ava/images/member/arena/rank_mark/platinum3.png', 'プラチナ3'],
  ['https://file.gameon.jp/ava/images/member/arena/rank_mark/platinum4.png', 'プラチナ4'],
  ['https://file.gameon.jp/ava/images/member/arena/rank_mark/platinum5.png', 'プラチナ5'],
  ['https://file.gameon.jp/ava/images/member/arena/rank_mark/star1.png', 'スター1'],
  ['https://file.gameon.jp/ava/images/member/arena/rank_mark/star2.png', 'スター2'],
  ['https://file.gameon.jp/ava/images/member/arena/rank_mark/star3.png', 'スター3'],
  ['https://file.gameon.jp/ava/images/member/arena/rank_mark/star4.png', 'スター4'],
  ['https://file.gameon.jp/ava/images/member/arena/rank_mark/star5.png', 'スター5'],
  ['https://file.gameon.jp/ava/images/member/arena/rank_mark/goldstar.png', 'ゴールドスター']
]);
// ランク画像からランクを取得する
export function getArenaRankName(url: string): string {
  return arenaRankUrlMap.get(url.replace(/(?<!:)\/\//,'/')) || 'ブロンズ5';
}
